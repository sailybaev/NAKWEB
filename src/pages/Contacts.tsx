        ...
        <div className="container mx-auto px-4 py-16">
          ...
          >
            ...
            <p className="text-lg text-gray-600 dark:text-gray-300 max-w-2xl mx-auto">
              {t('contacts.subtitle', 'Get in touch with us. We\'d love to hear from you.')}
            </p>
          </motion.div>
            ...
            >
              ...
              <div className="space-y-8">
                ...
                >
                  ...
                  <div>
                    <h3 className="font-semibold text-gray-800 dark:text-white mb-1">{t('contacts.phone', 'Phone')}</h3>
                ...
                >
                  ...
                  <div>
                    <h3 className="font-semibold text-gray-800 dark:text-white mb-1">{t('contacts.email', 'Email')}</h3>
                    <a href="mailto:info@nak.kz" className="text-gray-600 dark:text-gray-300 hover:text-blue-600 dark:hover:text-blue-400 transition-colors duration-300">
                      info@nak.kz
                    </a>
                  </div>
                </motion.div>
                ...
                >
                  ...
                  <div>
                    <h3 className="font-semibold text-gray-800 dark:text-white mb-1">{t('contacts.address', 'Address')}</h3>
