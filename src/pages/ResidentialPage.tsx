        ...
        return (
            <div className="min-h-screen flex items-center justify-center bg-gray-100">
                <div className="text-center">
                    <h1 className="text-4xl font-bold text-gray-900 mb-4">Complex Not Found</h1>
                    <p className="text-gray-600 mb-8">The residential complex you are looking for could not be found.</p>
                    <a 
                        href="/"
