...
export function Person({
  ...
  const defaultHeadline = t('aboutus.person.headline');
  const defaultQuestion = t('aboutus.person.question');
      ...
      <div className="max-w-5xl px-4 mx-auto sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 mt-8 md:mt-20 gap-y-6 md:grid-cols-2 gap-x-10">
          ...
          <div>
            ...
            <h3 className="mt-8 text-lg font-semibold text-gray-900">{question || defaultQuestion}</h3>
