      ...
      <div className="flex flex-col md:flex-row">
        <div className="bg-blue-600 text-white p-8 md:p-12 md:w-2/5">
          ...
          <div className="space-y-6">
            <div>
              <p className="text-blue-200 text-sm font-medium mb-2">Название ЖК</p>
            ...
            <div>
              ...
              <p>Пн-Пт: 9:00 - 18:00<br />Сб: 10:00 - 17:00<br />Вс: выходной</p>
            </div>
          </div>
        ...
        <div className="p-8 md:p-12 md:w-3/5">
          {submitSuccess ? (
            <div className="text-center py-12">
              ...
              <h3 className="text-2xl font-bold text-gray-800 mb-4">Спасибо за обращение!</h3>
            ...
            <>
              ...
              <p className="text-gray-600 mb-8">
                Заполните форму ниже, и наши специалисты свяжутся с вами в ближайшее время для консультации.
              </p>
