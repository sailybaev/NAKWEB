...
export const residentialComplexes: ResidentialComplex[] = [
	{
		...
		ceilingHeight: '3.0',
		completionDate: 'сдан в эксплуатацию',
		status: 'completed',
		address: 'г.Астана, ул. Мангилик-Рыскулова Онгарсынова',
		location: 'https://go.2gis.com/obekp',
		paymentOptions:
			'Акция Bolip Toleu с первоначальным взносом от 30%. 100% оплата со скидкой от 3% по программе лояльности NAK Club',
		description:
			'Arai Towers - находится в близости от основных достопримечательностей города, что позволяет Вам наслаждаться всей культурой и исторической обстановкой без лишних усилий и долгих поездок. 34 свободные квартиры.',
		...
		constructionFeatures:
			'система считывания номеров машин, система умный дом, touch ID',
		exteriorFinish:
			'фиброцементная панель, со вставками из алюминия, гранита, клинкерного кирпича',
		apartments: [
			{
				id: 'arai-1',
				type: '1-комнатная',
	...
	},
	{
		...
		paymentOptions:
			'Акция Bolip Toleu с первоначальным взносом от 30%. 100% оплата со скидкой от 3% по программе лояльности NAK Club. Jenil ипотека с первоначальным взносом от 30%',
		description:
			'Жилой комплекс «Eco Park» — это дом, где вы можете жить так, как вам хочется – стильно, современно и безопасно! 42 свободные квартиры.',
		finishType: 'предчистая',
		imageUrl: '/6.jpg',
		minPrice: 'от 558 000 ₸/м²',
		minPriceNumeric: 558000,
		presentation: 'https://clck.ru/35Rxeh',
		video: 'https://youtu.be/otQaga_6hTA',
		tour3d: 'https://clck.ru/35uKLH/',
		elevator:
			'В блоке 1, 2, 3 - в подъезде 3 лифта, с 4 по 10 блок - 2 лифта, 11 блок - 1 лифт',
		windows: 'панорамные',
		heating: 'центральное',
		constructionFeatures: 'монолитный каркас, заполнение газоблок',
		exteriorFinish:
			'фиброцементная плитка с алюминиевой вставкой и клинкерная плитка',
		apartments: [
			{
				id: 'eco-park-1',
				type: '1-комнатная',
			...
			},
			{
				...
				area: '60-75 м²',
				price: 'от 26 853 480 ₸',
				pricePerSqm: 'от 558 000 ₸/м²',
				pricePerSqmNumeric: 558000,
				available: true,
	...
	},
	{
		...
		location:
			'https://2gis.kz/astana/firm/70000001095215062?m=71.373237%2C51.130242%2F17.35',
		paymentOptions:
			'Акция Bolip Toleu с первоначальным взносом от 30%. Jenil ипотека с первоначальным взносом от 30%',
		description:
			'На проспекте Сыганак, в динамично развивающемся районе Астаны, расположен 9-этажный дом комфорт-класса, где стиль, удобство и современные технологии делают жизнь проще и приятнее. Здесь продумано всё, чтобы каждый день был наполнен уютом и комфортом. 236 свободных квартир.',
		...
		heating: 'центральное',
		constructionFeatures:
			'Разрешение на строительство есть, земля в собственности. Наружные стены материал (кирпич/газоблок), Отопление: радиатор биметаллический, Центральное отопление.',
		exteriorFinish: 'облицовочный кирпич, композитная панель и гранит',
		tour3d:
			'https://astana3d.kz/3d/nak/dariya/?clckid=a8037284#pano548172/-126.1/3.0/90.0',
		apartments: [
			{
				id: 'daryia-1',
				type: '1-комнатная',
	...
	},
	{
		...
		location:
			'https://2gis.kz/astana/geo/70030077011546665/71.52843%2C51.109914?m=71.5273%2C51.109943%2F17.35',
		paymentOptions:
			'Акция Bolip Toleu с первоначальным взносом от 30%. 100% оплата со скидкой от 3% по программе лояльности NAK Club. Jenil ипотека с первоначальным взносом от 30%',
		description:
			'ЖК комфорт "ANSAU RESIDENCE" – всего 295 квартир. В шаговой доступности вокзал Нурлы Жол. На территории детский сад. Современные системы безопасности Face ID и Touch ID. 227 свободных квартир.',
		finishType: 'предчистовая',
		imageUrl: '/Ansau.jpg',
		minPrice: 'от 350 000 ₸/м²',
		minPriceNumeric: 350000,
		elevator: 'В 1 подъезде 1 лифт, современный, высокоскоростной бесшумный',
		windows:
			'Алюмениевые конструкции, 5ти камерные, окна со сложным открыванием, 210х180см (увеличенные)',
		heating: 'центральное, радиаторы биметаллические',
		constructionFeatures:
			'Земля в собственности, дом кирпичный с плитами перекрытия, 220мм плита перекрытия. Двери в подъезд двойные, входная дверь в кв металлическая, утепленная. Подземный паркинг на 164 мест, высота паркинга 3 м.',
		exteriorFinish:
			'Декоративный кирпич, гранитная отделка первого этажа, фиброцементные панели',
		...
		apartments: [
			{
				...
				area: '40-55 м²',
				price: 'от 14 108 300 ₸',
				pricePerSqm: 'от 350 000 ₸/м²',
				pricePerSqmNumeric: 350000,
				available: true,
	...
	},
	{
		...
		paymentOptions: 'Стандартная ипотека. 100% оплата',
		description:
			'Royal Expo — это премиальный жилой комплекс в районе Экспо, предлагающий современный комфорт и удобства, включая просторные квартиры с улучшенной отделкой и современный паркинг. 8 свободных квартир.',
		finishType: 'предчистая',
		imageUrl: '/Royal.jpg',
		...
		heating: 'центральное',
		constructionFeatures:
			'дизайнерская отделка, мрамор, керамика, дерево, полированный метал, керамогранит, площадь от 74 до 187, в продаже блоки В7 и В12',
		exteriorFinish:
			'монолитный каркас, заполнение керамический кирпич, газоблок и гипсокартон',
		apartments: [
			{
				id: 'royal-expo-2',
				type: '2-комнатная',
	...
	},
	{
		...
		description:
			'ЖК бизнес-класса "Asylym Park 1" - введён в эксплуатацию с пешеходной аллеей.',
		finishType: 'предчистовая',
		imageUrl: '/Asylym.png',
	...
	},
	{
		...
		paymentOptions:
			'Отбасы банк 30/70 или 50/50, БЦК, Алтын банк, программа 7-20-25',
		description:
			'ЖК Комфорт класса "Томирис Тауэрс" - закрытый двор с детской и спортивной площадкой, ландшафтный дизайн, дизайнерские холлы, бесшумные лифты.',
		finishType: 'предчистая',
	...
	},
	{
		...
		description:
			'"Asylym" - пешеходная парковая зона с выходом на арку, закрытые дворы. Охраняемая территория с системой видеонаблюдения.',
		finishType: 'предчистовая',
		...
		heating: 'центральное',
		constructionFeatures:
			'остались 3-4 комн, пешеходная парковая зона с выходом на арку, закрытые дворы. Охраняемая территория, видео обзор и детской площадки из квартиры, сиситема считывания номеров машин, видеодомофон, датчики протечки воды, виртуальный ассистент алиса.яндекс, дверной проем 2,4 метра 0,9',
		exteriorFinish:
			'фиброцементная панель, со вставками из алюминия, гранита, клинкерного кирпича',
		apartments: [
			{
	...
	},
	{
		...
		description:
			'ЖК Комфорт класса "AYLET" - только 3х комнатные квартиры, закрытый двор, паркинг.',
		finishType: 'предчистая',
		imageUrl: '/aulet.jpg',
	...
	},
	{
		...
		elevator: '',
		windows:
			'алюминиевые и металлопластиковые стеклопакеты немецкого бренда Rehau',
		heating: 'центральное',
		constructionFeatures:
			'подземный паркинг (но его не продаем, фактически есть)',
	...
	},
	{
		...
		description:
			'Жилой комплекс "Triumph Exclusive" – клубный дом, всего 47 квартир в 200 метрах от Триумфальной Арки, с панорамными окнами и прекрасным видом, дизайнерскими холлами, фитнес-залом и игровой комнатой.',
		finishType: 'предчистовая',
	...
	},
	{
		...
		paymentOptions: '',
		description:
			'Жилой комплекс комфорт-класса "Tomiris Towers" с закрытым двором, детской и спортивной площадкой, ландшафтным дизайном, дизайнерскими холлами и бесшумными лифтами.',
		finishType: 'предчистовая',
		imageUrl: '/tomiris.png',
